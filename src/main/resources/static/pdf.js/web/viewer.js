...
const defaultOptions = {
  ...
  cMapUrl: {
    value: window.contextPath + "/pdf.js/web/cmaps/",
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  standardFontDataUrl: {
    value: window.contextPath + "/pdf.js/web/standard_fonts/",
    kind: OptionKind.API
  },
  verbosity: {
    value: 1,
  ...
  workerSrc: {
    value: window.contextPath + "/pdf.js/build/pdf.worker.js",
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.sandboxBundleSrc = {
    value: window.contextPath + "/pdf.js/build/pdf.sandbox.js",
    kind: OptionKind.VIEWER
  };
}
...
if (typeof window !== "undefined" && window["pdfjs-dist/build/pdf"]) {
  ...
  pdfjsLib = require(window.contextPath + "/pdf.js/build/pdf.js");
}
