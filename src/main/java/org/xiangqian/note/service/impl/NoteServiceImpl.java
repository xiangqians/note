...
//
//    @Override
//    public org.xiangqian.note.model.List<NoteEntity> list(NoteEntity vo, Integer offset) {
//        if (offset == null) {
//            offset = 1;
//        }
//        Long pid = vo.getPid();
//        org.xiangqian.note.model.List list = new org.xiangqian.note.model.List(offset);
...
//                Set<Long> pids = ((org.xiangqian.note.model.List<NoteEntity>) list).stream().map(NoteEntity::getPs)
...
//                    for (NoteEntity entity : (org.xiangqian.note.model.List<NoteEntity>) list) {
